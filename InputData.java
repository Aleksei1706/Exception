...
public class InputData {
    public String[] enterData() {
        ...
        while (true){
            System.out.println("Введите строку через ПРОБЕЛ на английской раскладке (строка должна содержать Ф.И.О, дату рождения - dd.mm.yyyy, номер телефона - цифры, пол - f/m ) : ");
